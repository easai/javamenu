...
public class JavaMenuMenu {
	Locale locale = Locale.US;
	JMenuItem mi;
	JMenuBar mb = new JMenuBar();
	JMenu m[];
	Hashtable<JMenuItem, MENUITEM> comp = new Hashtable<>();static String menus[] = { "File","Tools","Help" };
String menuitems[][] = { {"Open","Save","SaveAs","Quit"},{"Convert"},{"About"} };
enum MENUITEM{nFileOpen, nFileSave, nFileSaveAs, nFileQuit, nToolsConvert, nHelpAbout };
	MENUITEM mi_num[][] = {{MENUITEM.nFileOpen, MENUITEM.nFileSave, MENUITEM.nFileSaveAs, MENUITEM.nFileQuit},{MENUITEM.nToolsConvert},{MENUITEM.nHelpAbout} };
